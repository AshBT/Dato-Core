...
/**************************************************************************/
  ...
  std::vector<std::shared_ptr<sarray<flexible_type>>> 
      fetch_vertex_data_field(std::string column_name, size_t group = 0);
   ...
   */
  std::vector<std::shared_ptr<sarray<flexible_type>>>
      fetch_edge_data_field(std::string column_name, size_t groupa = 0, size_t groupb = 0);
 ...
 private:
  ...
  typedef std::unordered_map<flexible_type, size_t> vid_hash_map_type;
