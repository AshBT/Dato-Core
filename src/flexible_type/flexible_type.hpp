...
#ifndef GRAPHLAB_FLEXIBLE_TYPE_HPP
#define GRAPHLAB_FLEXIBLE_TYPE_HPP
#include <string>
#include <vector>
#include <tuple>
#include <iostream>
...
template<>
struct hash<graphlab::flexible_type> {
  inline FLEX_ALWAYS_INLINE size_t operator()(const graphlab::flexible_type& s) const {
    return s.hash();
  }
};
