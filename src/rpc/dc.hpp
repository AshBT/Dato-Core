...
class distributed_control{
 ...
 public:
  ...
  // true if the last_dc was automatically created as a result of a call 
  // to get_instance
  static bool automatic_creation;
  ...
  /**
   * \internal
   * Deletes a singleton of the distributed control object if it exists
   * and was automatically created. Do not use.
   */
