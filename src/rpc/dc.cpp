...
bool distributed_control::automatic_creation = false;
...
void distributed_control::delete_instance() {
...
void distributed_control::init(const std::vector<std::string> &machines,
  ...
  ASSERT_MSG(last_dc == NULL,
         "Only one distributed control object may be created at any one time.");
