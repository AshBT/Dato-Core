...
ctypedef long flex_int
ctypedef double flex_float
ctypedef pair[long,int] pflex_date_time
...
cdef extern from "<flexible_type/flexible_type.hpp>" namespace "graphlab":
    cdef cppclass flexible_type:
        ...
        flexible_type& set_date_time "set_date_time_from_timestamp_and_offset"(const pflex_date_time& other)
