...
#ifndef GRAPHLAB_UNITY_GL_SGRAPH_HPP
#define GRAPHLAB_UNITY_GL_SGRAPH_HPP
#include <cmath>
#include <memory>
#include <cstddef>
#include <string>
 ...
 * ### Example
 *
 * Please checkout graphlab/sdk_example/sgraph_example.cpp for a concrete example.
 */
class gl_sgraph {
 ...
 public:
   ...
   *                   {"dest": {1,2,3,4,0}} };
   * g = graphlab.SGraph().add_edges(edges, "source", "dest");
   * g.vertices()['degree'] = 0
   * std::cout << g.vertices() << std::endl;
   *
