...
#ifndef GRAPHLAB_UNITY_GL_SFRAME_HPP
#define GRAPHLAB_UNITY_GL_SFRAME_HPP
#include <cmath>
#include <memory>
#include <cstddef>
#include <string>
 ...
 * \endcode
 *
 * \see graphlab::aggregate::STD
 * \see graphlab::aggregate::VAR
 * \see gl_sframe::groupby
 */
...
class gl_sframe {
 public:
   ...
   * STDV, and VAR. See graphlab::aggregate for more detail on the
   * aggregators.
   *
...
#endif // GRAPHLAB_UNITY_GL_SFRAME_HPP
