...
namespace graphlab {
  ...
  std::string unity_global::load_toolkit(std::string soname,
    ...
    logstream(LOG_INFO) << "dlopen of " << sanitize_url(soname) << std::endl;
  ...
  /**************************************************************************/
    ...
    get_toolkit_function_registration_type get_toolkit_function_registration =
        reinterpret_cast<get_toolkit_function_registration_type>
          (dlsym(dl, "get_toolkit_function_registration"));
    //cannot get the regular name. Try the name mangled name
    if (get_toolkit_function_registration == nullptr) {
      get_toolkit_function_registration =
          reinterpret_cast<get_toolkit_function_registration_type>
          (dlsym(dl, "_Z33get_toolkit_function_registrationv"));
    }
...
/**************************************************************************/
    ...
    get_toolkit_class_registration_type get_toolkit_class_registration =
        reinterpret_cast<get_toolkit_class_registration_type>
          (dlsym(dl, "get_toolkit_class_registration"));
    //cannot get the regular name. Try the name mangled name
    if (get_toolkit_class_registration == nullptr) {
      get_toolkit_class_registration =
          reinterpret_cast<get_toolkit_class_registration_type>
          (dlsym(dl, "_Z30get_toolkit_class_registrationv"));
    }
