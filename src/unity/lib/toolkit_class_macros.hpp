...
#ifndef GRAPHLAB_UNITY_TOOLKIT_CLASS_MACROS_HPP
#define GRAPHLAB_UNITY_TOOLKIT_CLASS_MACROS_HPP
#include <string>
 ...
 *
 * For detailed usage descriptions, see page_graphlab_extension_interface .
 *
 * Example:
 * \code
...
#define REGISTER_CLASS(class_name) \
    { \
       ::graphlab::toolkit_class_specification spec;  \
       class_name c; \
       spec.name = c.name(); \
       spec.constructor = +[]() { return (::graphlab::model_base*)(new class_name); }; \
...
/// \}
#endif // GRAPHLAB_UNITY_TOOLKIT_MAGIC_MAC ROS_HPP
