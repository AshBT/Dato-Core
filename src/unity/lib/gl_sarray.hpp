...
#ifndef GRAPHLAB_UNITY_GL_SARRAY_HPP
#define GRAPHLAB_UNITY_GL_SARRAY_HPP
#include <cmath>
#include <memory>
#include <cstddef>
#include <string>
...
/**************************************************************************/
  ...
  /**
   * Returns a gl_sarray of values parsed from an avro file.
   */
  static gl_sarray from_avro(const std::string& filename);
   ...
   * \ref graphlab::image_type of uniform size.
   * 
