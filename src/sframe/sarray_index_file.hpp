...
*/
#ifndef GRAPHLAB_UNITY_SARRAY_INDEX_FILE_HPP
#define GRAPHLAB_UNITY_SARRAY_INDEX_FILE_HPP
#include <cstdint>
#include <string>
#include <vector>
#include <map>
...
/**
 * Writes an sarray v1 index file to disk.
...
void write_index_file(std::string index_file, 
                      const index_file_information& info);
