...
*/
#ifndef GRAPHLAB_UNITY_LIB_SFRAME_READER_HPP
#define GRAPHLAB_UNITY_LIB_SFRAME_READER_HPP
#include <iostream>
#include <algorithm>
#include <memory>
#include <vector>
...
inline int distance(const graphlab::sframe_iterator& begin, 
                    const graphlab::sframe_iterator& end) {
  return end - begin;
}
