...
*/
#ifndef GRAPHLAB_UNITY_LIB_SFRAME_HPP
#define GRAPHLAB_UNITY_LIB_SFRAME_HPP
#include <iostream>
#include <algorithm>
#include <memory>
#include <vector>
...
typedef graphlab::function_output_iterator<
...
// These functions are only valid when the array is opened for writing
  ...
  bool delete_files_on_destruction(bool del);
