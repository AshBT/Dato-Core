...
class new_flexible_type_test : public CxxTest::TestSuite {
  ...
  public:
    ...
    void test_mutating_operators() {
      ...
      f = 8 / f;
      TS_ASSERT_DELTA(f, 1.818182, 1E-6);
    ...
    void test_parser() {
      ...
      TS_ASSERT_EQUALS((int)ret.first.array_at(0).get_type(), (int)flex_type_enum::VECTOR);
